    ...
    >
      <div className="flex flex-col w-full">
        <div className="flex flex-col sm:flex-row w-full h-1/2">
          <div
            className="w-1/2 pr-6 sm:w-full justify-between flex items-center border-r border-zinc-500 hover:bg-zinc-300 hover:text-black transform duration-300"
            style={{ height: "calc(50vh - 75px)" }}
          >
            <h2 className="writing-vertical h-full text-zinc-700 uppercase text-4xl text-center transform duration-300 cursor-default bg-zinc-300 px-2">
              Design
            </h2>
          ...
          <div
            className="w-1/2 pl-6 sm:w-full justify-between flex items-center border-r border-zinc-500 hover:bg-zinc-300 hover:text-black transform duration-300"
            style={{ height: "calc(50vh - 75px)" }}
          >
            <div className="w-[60%] h-full py-8">
              <p>
        ...
        <div
          className="w-full h-1/2 flex flex-col items-center hover:bg-zinc-300 hover:text-black transform duration-300"
          style={{ height: "calc(50vh)" }}
        >
          <div className="text-zinc-700 w-full uppercase text-4xl text-center transform duration-300 cursor-default bg-zinc-300 py-2">
            Stack
          </div>
