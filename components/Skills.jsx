      ...
      <div className="max-w-[1240px] mx-auto flex flex-col justify-center h-full ">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 tracking-widest font-robot">
          <div className="px-4 text-white hover:text-[#63698E]">
            <div className="grid grid-cols-2 gap-4 justify-center items-center ease-in duration-300 rounded-md border-[#63698E]  hover:bg-black border-2 hover:shadow-neon-sol ">
          ...
          <div className=" px-4 text-white hover:text-[#f0db4f]">
            <div className="grid grid-cols-2 gap-4 justify-center items-center ease-in duration-300 rounded-md border-[#f0db4f]  hover:bg-black  border-2 hover:shadow-neon-yellow ">
              <div className="m-auto">
          ...
          <div className="px-4 text-white hover:text-[#007ACC]">
            <div className="grid grid-cols-2 gap-4 justify-center items-center ease-in duration-300 rounded-md border-[#007ACC]  hover:bg-black border-2 hover:shadow-neon-type ">
              <div className="m-auto">
          ...
          <div className="px-4 text-white hover:text-[#37bcf8]">
            <div className="grid grid-cols-2 gap-4 justify-center items-center ease-in duration-300 rounded-md border-[#37bcf8]  hover:bg-black border-2 hover:shadow-neon-tailwind ">
              <div className="m-auto">
          ...
          <div className="px-4  text-white hover:text-[#61d9fb]">
            <div className="grid grid-cols-2 gap-4 justify-center items-center ease-in duration-300 rounded-md border-[#61d9fb]  hover:bg-black border-2 hover:shadow-neon-blue ">
              <div className="m-auto">
          ...
          <div className="px-4 text-white hover:text-[#3E863E]">
            <div className="grid grid-cols-2 gap-4 justify-center items-center ease-in duration-300 rounded-md border-[#3E863E]  hover:bg-black border-2 hover:shadow-neon-green ">
              <div className="m-auto">
