    ...
    <div className="relative flex items-center justify-center h-auto w-full group rounded-sm p-1 transition duration-300 text-white pb-6">
      <div className="relative flex flex-col justify-center items-center ease-in border-2 border-slate-600 hover:border-[#ff2a6d] duration-300 hover:shadow-neon-main rounded-md border-opacity-40">
        <Image
          ...
          alt="/"
        />
        <div className="hidden lg:block md:block bg-black w-full ease-in border-2 border-[#ff2a6d] hover:border-[#ff2a6d] duration-200 rounded-md border-opacity-40 p-2 text-center font-rale h-auto">
          <p>{description}</p>
        </div>
      </div>
      <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] font-rale">
        <h3 className="text-2xl sm:text-sm tracking-wider text-center ">
          {title}
        </h3>
